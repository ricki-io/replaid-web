...
const svg = `<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="100" y="260" font-family="Arial, Helvetica, sans-serif" font-weight="700" font-size="88" fill="#ffffff" letter-spacing="-3">Give your AI agent</text>
  <text x="100" y="370" font-family="Arial, Helvetica, sans-serif" font-weight="700" font-size="88" fill="#ffffff" letter-spacing="-3">a customer inbox.</text>
  <text x="100" y="440" font-family="Arial, Helvetica, sans-serif" font-weight="400" font-size="30" fill="#999999">Connect channels. Control actions. Inspect results.</text>
